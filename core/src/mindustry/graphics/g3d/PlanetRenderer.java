...
public class PlanetRenderer implements Disposable{
    ...
    complementaryOutlineColor = outlineColor.cpy().shiftHue(180),
    complementaryHoverColor = hoverColor.cpy().shiftHue(180),
    complementaryBorderColor = borderColor.cpy().shiftHue(180),
